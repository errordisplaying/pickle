        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="group bg-[#5C4A3A] rounded-[28px] overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer hover:-translate-y-1">
            ...
            <div className="p-6 text-white">
              ...
              <p className="text-sm opacity-80 mb-4 leading-relaxed">Fresh, pre-portioned ingredients delivered straight to your door. Skip the grocery store and start cooking restaurant-quality meals tonight. Use code CHICKPEA20.</p>
