...
export default function SmartSwapSection({ substituteRef }: SmartSwapSectionProps) {
  ...
  return (
    <section ref={substituteRef} className="section-pinned z-30">
      ...
      {/* Swap Badge */}
      <div className="substitute-badge absolute left-[10vw] bottom-[6vh] bg-[#8B7355] text-white px-6 py-3 rounded-full font-semibold shadow-xl">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="font-semibold text-[#8B7355]">{swap.swap}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      <Badge className="bg-[#8B7355]/10 text-[#8B7355] rounded-full text-xs border-0">
